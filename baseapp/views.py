...
def updateRoom(request, pk):
    room = Room.objects.get(id=pk)
    # prefills the form with this instance
    ...
    context = {
        'form': form, 'topics': topics, 'room': room
    }
    return render(request, 'baseapp/room_form.html', context)
...
def topicsPage(request):
    ...
    return render(request, 'baseapp/topics.html', context={'topics': topics})

def activitiesPage(request):
    room_messages = Message.objects.all()
    return render(request, 'baseapp/activity.html', context={'room_messages': room_messages})
